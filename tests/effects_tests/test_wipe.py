...
from varoascii.effects import effect_wipe
from varoascii.engine.terminal import TerminalConfig
from varoascii.utils.graphics import Color, ColorPair

if TYPE_CHECKING:
    from varoascii.utils.argutils import CharacterGroup
    from varoascii.utils.easing import EasingFunction
    from varoascii.utils.graphics import Gradient
