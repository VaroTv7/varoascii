"""Pytest fixtures and constants for varoascii package."""
...
from varoascii.utils import geometry, graphics
from varoascii.utils.argutils import CharacterGroup
from varoascii.utils.easing import (
    EasingFunction,
    in_back,
    in_bounce,
    in_circ,
