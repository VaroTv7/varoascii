"""Unit tests for the animation functionality within the varoascii package."""

import pytest

from varoascii.engine.animation import CharacterVisual, Frame, Scene
from varoascii.engine.base_character import EffectCharacter
from varoascii.utils import easing
