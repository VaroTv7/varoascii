...
from varoascii.utils.spanningtree.algo.recursivebacktracker import RecursiveBacktracker
...
def test_recursive_backtracker_step_links_an_unvisited_neighbor(
    ...
    monkeypatch.setattr(
        "varoascii.utils.spanningtree.algo.recursivebacktracker.random.choice",
        fake_choice,
    )
