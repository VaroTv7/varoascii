...
from varoascii import Color, Coord, EffectCharacter, EventHandler, Gradient, Scene, easing
...
class CrumbleConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            "Example: varoascii crumble --final-gradient-stops 5CE1FF FF8C00 --final-gradient-steps 12 "
