...
from varoascii import Color, ColorPair, Coord, EffectCharacter, EventHandler, Gradient, Scene, easing
...
class ScatteredConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            f"{argutils.EASING_EPILOG} Example: varoascii scattered --final-gradient-stops ff9048 "
