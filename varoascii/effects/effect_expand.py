...
from varoascii import Color, EffectCharacter, EventHandler, Gradient, Scene, easing
...
class ExpandConfig(BaseConfig):
    ...
    parser_spec = argutils.ParserSpec(
        ...
        epilog=(
            ...
            "Example: varoascii expand --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 "
