...
from varoascii import Color, EffectCharacter, EventHandler, Gradient, Path, Scene
...
class ErrorCorrectConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            ...
            "Example: varoascii errorcorrect --error-pairs 0.1 --swap-delay 6 --error-color e74c3c "
