...
from varoascii import Animation, Color, ColorPair, EffectCharacter, Gradient, easing
...
class HighlightConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            f"{argutils.EASING_EPILOG}Example: varoascii highlight --highlight-brightness 1.75 "
            "--highlight-direction "
