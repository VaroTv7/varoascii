...
from varoascii import Color, ColorPair, Coord, EffectCharacter, Gradient, easing
...
class SliceConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            f"{argutils.EASING_EPILOG} Example: varoascii slice --final-gradient-stops 8A008A 00D1FF "
