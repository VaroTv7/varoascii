...
from varoascii import Animation, Color, ColorPair, Coord, EffectCharacter, Gradient, Terminal
...
class MatrixConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            "Example: varoascii matrix --highlight-color dbffdb --rain-color-gradient 92be92 185318 "
