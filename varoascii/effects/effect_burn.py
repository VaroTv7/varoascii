...
from varoascii import Color, EffectCharacter, EventHandler, Gradient
...
from varoascii.utils.graphics import ColorPair
from varoascii.utils.spanningtree.algo.primssimple import PrimsSimple
...
class BurnConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            "Example: varoascii burn --starting-color 837373 --burn-colors ffffff fff75d fe650d 8a003c "
