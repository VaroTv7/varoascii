...
from varoascii import Color, ColorPair, EffectCharacter, EventHandler, Gradient, Scene
...
class DecryptConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            "Example: varoascii decrypt --typing-speed 2 --ciphertext-colors 008000 00cb00 00ff00 "
