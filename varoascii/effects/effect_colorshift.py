...
from varoascii import Color, EffectCharacter, EventHandler, Gradient, geometry
...
class ColorShiftConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            "Example: varoascii colorshift --gradient-stops e81416 ffa500 faeb36 79c314 487de7 4b369d "
