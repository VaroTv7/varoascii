...
from varoascii import Color, ColorPair, Coord, EffectCharacter, EventHandler, Gradient, easing, geometry
...
if typing.TYPE_CHECKING:
    from varoascii.engine import motion
...
class RingsConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            "Example: varoascii rings --ring-colors ab48ff e7b2b2 fffebd --final-gradient-stops ab48ff "
