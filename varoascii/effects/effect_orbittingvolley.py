...
from varoascii import Color, ColorPair, Coord, EffectCharacter, EventHandler, Gradient, Terminal, easing
...
class OrbittingVolleyConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            f"{argutils.EASING_EPILOG} Example: varoascii orbittingvolley --top-launcher-symbol █ "
