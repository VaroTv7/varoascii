...
from varoascii import Color, Coord, EffectCharacter, EventHandler, Gradient, Terminal, easing, geometry
...
class BubblesConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        "Example: varoascii bubbles [--rainbow] --bubble-colors d33aff 7395c4 43c2a7 02ff7f "
