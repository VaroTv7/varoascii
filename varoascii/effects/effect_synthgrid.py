...
from varoascii import Color, ColorPair, Coord, EffectCharacter, EventHandler, Gradient, Terminal, geometry
...
class SynthGridConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            "Example: varoascii synthgrid --grid-gradient-stops CC00CC ffffff --grid-gradient-steps 12 "
