...
from varoascii import Color, ColorPair, Coord, EffectCharacter, Gradient, easing, geometry
from varoascii.engine import animation, motion
...
class SpotlightsConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            f"{argutils.EASING_EPILOG} Example: varoascii spotlights --final-gradient-stops ab48ff "
