...
from varoascii import Color, ColorPair, Coord, EffectCharacter, EventHandler, Gradient, easing
...
from varoascii.utils.exceptions import DuplicateEventRegistrationError
...
class PrintConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        "carriage return.",
        epilog=(
            f"{argutils.EASING_EPILOG} Example: varoascii print --final-gradient-stops 02b8bd "
