...
from varoascii import Color, ColorPair, EffectCharacter, Gradient, easing, geometry
...
class SlideConfig(BaseConfig):
    ...
    parser_spec: argutils.ParserSpec = argutils.ParserSpec(
        ...
        epilog=(
            f"{argutils.EASING_EPILOG} Example: varoascii slide --movement-speed 0.8 --grouping row "
