"""Custom exceptions for handling errors related to motion in the varoascii package."""
...
class PathInvalidSpeedError(varoasciiError):
...
class WaypointNotFoundError(varoasciiError):
...
class PathNotFoundError(varoasciiError):
...
class ActivateEmptyPathError(varoasciiError):
...
class DuplicatePathIDError(varoasciiError):
...
class DuplicateWaypointIDError(varoasciiError):
