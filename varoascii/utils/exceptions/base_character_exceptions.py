"""Custom exceptions for handling errors related to EffectCharacters in the varoascii package."""
...
if TYPE_CHECKING:
    from varoascii import Coord, EventHandler, Path, Scene, Waypoint


class EventRegistrationCallerError(varoasciiError):
...
class EventRegistrationTargetError(varoasciiError):
...
class DuplicateEventRegistrationError(varoasciiError):
