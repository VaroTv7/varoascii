"""Custom exceptions for handling errors related to the Terminal in the varoascii package."""
...
if TYPE_CHECKING:
    from varoascii.utils.argutils import CharacterGroup, CharacterSort, ColorSort


class InvalidCharacterGroupError(varoasciiError):
...
class InvalidCharacterSortError(varoasciiError):
...
class InvalidColorSortError(varoasciiError):
...
class UnsupportedAnsiSequenceError(varoasciiError):
    ...
    def __init__(self, sequence: str) -> None:
        ...
        self.message = (
            ...
            "varoascii supports common SGR foreground/background color sequences, fetch-style CSI cursor "
