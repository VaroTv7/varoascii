...
manager
([effect.terminal_output()](./engine/baseeffect.md#varoascii.engine.base_effect.BaseEffect.terminal_output))
to handle terminal setup/teardown and cursor positioning.

The following example plays the [Slide](./effects/slide.md) effect animation using the [effect.terminal_output()](./engine/baseeffect.md#varoascii.engine.base_effect.BaseEffect.terminal_output) context manager.
...
[ColorShiftConfig.cycles](./effects/colorshift.md#varoascii.effects.effect_colorshift.ColorShiftConfig) config
