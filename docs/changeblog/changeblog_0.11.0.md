...
requested [in an issue](https://github.com/ChrisBuilds/varoascii/issues/14) and support for anchoring the Canvas within the
...
google query for "varoascii" presented the source of this attention.
...
[raised](https://github.com/ChrisBuilds/varoascii/issues/14) which asked for an obvious capability. Allow the
...
was noticed by a user who submitted a [great issue](https://github.com/ChrisBuilds/varoascii/issues/13)
...
[0.11.0](https://github.com/ChrisBuilds/varoascii/blob/main/CHANGELOG.md)
