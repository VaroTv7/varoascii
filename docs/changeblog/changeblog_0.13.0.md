...
In other news, varoascii is currently a screensaver in [Omarchy](https://omarchy.org/).
...
??? info "Reusing the terminal in your Python application."
    ...
    ```python
    from varoascii.effects import Highlight, Slide, Wipe
...
[0.13.0](https://github.com/ChrisBuilds/varoascii/blob/main/CHANGELOG.md)
