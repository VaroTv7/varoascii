...
There is a new [TerminalConfig](../engine/terminal/terminalconfig.md#varoascii.engine.terminal.TerminalConfig.existing_color_handling) command line argument `--existing-color-handling` that determines how these sequences are used within effects.
...
[this Issue](https://github.com/ChrisBuilds/varoascii/issues/37).
...
[0.12.0](https://github.com/ChrisBuilds/varoascii/blob/main/CHANGELOG.md)
