...
[Reference](./effects/beams.md){ .md-button } [Config](./effects/beams.md#varoascii.effects.effect_beams.BeamsConfig){ .md-button }
...
??? example "Beams Command Line Arguments"
    ...
    Example: varoascii beams --beam-row-symbols ▂ ▁ _ --beam-column-symbols ▌ ▍ ▎ ▏ --beam-delay 10 --beam-row-speed-range 10-40 --beam-column-speed-range 6-10 --beam-gradient-stops ffffff 00D1FF 8A008A --beam-gradient-steps 2 8 --beam-gradient-frames 2 --final-gradient-stops 8A008A 00D1FF ffffff --final-gradient-steps 12 --final-gradient-frames 5 --final-gradient-direction vertical --final-wipe-speed 1
    ```
---
...
[Reference](./effects/binarypath.md){ .md-button } [Config](./effects/binarypath.md#varoascii.effects.effect_binarypath.BinaryPathConfig){ .md-button }
...
??? example "Binarypath Command Line Arguments"
    ...
    Example: varoascii binarypath --final-gradient-stops 00d500 007500 --final-gradient-steps 12 --final-gradient-direction vertical --binary-colors 044E29 157e38 45bf55 95ed87 --movement-speed 1.0 --active-binary-groups 0.05
    ```
---
...
[Reference](./effects/blackhole.md){ .md-button } [Config](./effects/blackhole.md#varoascii.effects.effect_blackhole.BlackholeConfig){ .md-button }
...
??? example "Blackhole Command Line Arguments"
    ...
    Example: varoascii blackhole --star-colors ffcc0d ff7326 ff194d bf2669 702a8c 049dbf --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 --final-gradient-direction vertical
    ```
---
...
[Reference](./effects/bouncyballs.md){ .md-button } [Config](./effects/bouncyballs.md#varoascii.effects.effect_bouncyballs.BouncyBallsConfig){ .md-button }
...
??? example "Bouncyballs Command Line Arguments"
    ...
    Example: varoascii bouncyballs --ball-colors d1f4a5 96e2a4 5acda9 --ball-symbols o "*" O 0 . --final-gradient-stops f8ffae 43c6ac --final-gradient-steps 12 --final-gradient-direction diagonal --ball-delay 7 --movement-speed 0.25 --easing OUT_BOUNCE
    ```
---
...
[Reference](./effects/bubbles.md){ .md-button } [Config](./effects/bubbles.md#varoascii.effects.effect_bubbles.BubblesConfig){ .md-button }
...
??? example "Bubbles Command Line Arguments"
    ...
    Example: varoascii bubbles --bubble-colors d33aff 7395c4 43c2a7 02ff7f --pop-color ffffff --final-gradient-stops d33aff 02ff7f --final-gradient-steps 12 --final-gradient-direction diagonal --bubble-speed 0.1 --bubble-delay 50 --pop-condition row --easing IN_OUT_SINE
    ```
---
...
[Reference](./effects/burn.md){ .md-button } [Config](./effects/burn.md#varoascii.effects.effect_burn.BurnConfig){ .md-button }
...
??? example "Burn Command Line Arguments"
    ...
    Example: varoascii burn --starting-color 837373 --burn-colors ffffff fff75d fe650d 8a003c 510100 --smoke-chance 0.2 --final-gradient-stops 00c3ff ffff1c --final-gradient-steps 12
    ```
---
...
[Reference](./effects/colorshift.md){ .md-button } [Config](./effects/colorshift.md#varoascii.effects.effect_colorshift.ColorShiftConfig){ .md-button }
...
??? example "ColorShift Command Line Arguments"
    ...
    Example: varoascii colorshift --gradient-stops 0000ff ffffff 0000ff --gradient-steps 12 --gradient-frames 10 --cycles 3 --travel --travel-direction radial --final-gradient-stops 00c3ff ffff1c --final-gradient-steps 12
    ```
---
...
[Reference](./effects/crumble.md){ .md-button } [Config](./effects/crumble.md#varoascii.effects.effect_crumble.CrumbleConfig){ .md-button }
...
??? example "Crumble Command Line Arguments"
    ...
    Example: varoascii crumble --final-gradient-stops 5CE1FF FF8C00 --final-gradient-steps 12 --final-gradient-direction diagonal
    ```
---
...
[Reference](./effects/decrypt.md){ .md-button } [Config](./effects/decrypt.md#varoascii.effects.effect_decrypt.DecryptConfig){ .md-button }
...
??? example "Decrypt Command Line Arguments"
    ...
    Example: varoascii decrypt --typing-speed 2 --ciphertext-colors 008000 00cb00 00ff00 --final-gradient-stops eda000 --final-gradient-steps 12 --final-gradient-direction vertical
    ```
---
...
[Reference](./effects/errorcorrect.md){ .md-button } [Config](./effects/errorcorrect.md#varoascii.effects.effect_errorcorrect.ErrorCorrectConfig){ .md-button }
...
??? example "ErrorCorrect Command Line Arguments"
    ...
    Example: varoascii errorcorrect --error-pairs 0.1 --swap-delay 10 --error-color e74c3c --correct-color 45bf55 --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 --movement-speed 0.5
    ```
---
...
[Reference](./effects/expand.md){ .md-button } [Config](./effects/expand.md#varoascii.effects.effect_expand.ExpandConfig){ .md-button }
...
??? example "Expand Command Line Arguments"
    ...
    Example: varoascii expand --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 --final-gradient-frames 5 --movement-speed 0.35 --expand-easing IN_OUT_QUART
    ```
---
...
[Reference](./effects/fireworks.md){ .md-button } [Config](./effects/fireworks.md#varoascii.effects.effect_fireworks.FireworksConfig){ .md-button }
...
??? example "Fireworks Command Line Arguments"
    ...
    Example: varoascii fireworks --firework-colors 88F7E2 44D492 F5EB67 FFA15C FA233E --firework-symbol o --firework-volume 0.02 --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 --launch-delay 60 --explode-distance 0.1 --explode-anywhere
    ```
---
...
[Reference](./effects/highlight.md){ .md-button } [Config](./effects/highlight.md#varoascii.effects.effect_highlight.HighlightConfig){ .md-button }
...
??? example "Highlight Command Line Arguments"
    ...
    Example: varoascii highlight --highlight-brightness 1.5 --highlight-direction
...
[Reference](./effects/laseretch.md){ .md-button } [Config](./effects/laseretch.md#varoascii.effects.effect_laseretch.LaserEtchConfig){ .md-button }
...
??? example "LaserEtch Command Line Arguments"
    ...
    Example: varoascii laseretch --etch-speed 2 --etch-delay 5 --etch-direction row_top_to_bottom --cool-gradient-stops ffe680 ff7b00 --laser-gradient-stops ffffff 376cff --spark-gradient-stops ffffff ffe680 ff7b00 1a0900 --spark-cooling-frames 10 --final-gradient-stops 8A008A 00D1FF ffffff --final-gradient-steps 8  --final-gradient-frames 5 --final-gradient-direction vertical    
    ```
---
...
[Reference](./effects/matrix.md){ .md-button } [Config](./effects/matrix.md#varoascii.effects.effect_matrix.MatrixConfig){ .md-button }
...
[Reference](./effects/middleout.md){ .md-button } [Config](./effects/middleout.md#varoascii.effects.effect_middleout.MiddleOutConfig){ .md-button }
...
??? example "MiddleOut Command Line Arguments"
    ...
    Example: varoascii middleout --starting-color 8A008A --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 --expand-direction vertical --center-movement-speed 0.35 --full-movement-speed 0.35 --center-easing IN_OUT_SINE --full-easing IN_OUT_SINE
    ```
---
...
[Reference](./effects/orbittingvolley.md){ .md-button } [Config](./effects/orbittingvolley.md#varoascii.effects.effect_orbittingvolley.OrbittingVolleyConfig){ .md-button }
...
??? example "OrbittingVolley Command Line Arguments"
    ...
    Example: varoascii orbittingvolley --top-launcher-symbol █ --right-launcher-symbol █ --bottom-launcher-symbol █ --left-launcher-symbol █ --final-gradient-stops FFA15C 44D492 --final-gradient-steps 12 --launcher-movement-speed 0.5 --character-movement-speed 1 --volley-size 0.03 --launch-delay 50 --character-easing OUT_SINE
    ```
---
...
[Reference](./effects/overflow.md){ .md-button } [Config](./effects/overflow.md#varoascii.effects.effect_overflow.OverflowConfig){ .md-button }
...
??? example "Overflow Command Line Arguments"
    ...
    Example: varoascii overflow --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 --overflow-gradient-stops f2ebc0 8dbfb3 f2ebc0 --overflow-cycles-range 2-4 --overflow-speed 3
    ```
---
...
[Reference](./effects/pour.md){ .md-button } [Config](./effects/pour.md#varoascii.effects.effect_pour.PourConfig){ .md-button }
...
??? example "Pour Command Line Arguments"
    ...
    Example: varoascii pour --pour-direction down --movement-speed 0.2 --gap 1 --starting-color FFFFFF --final-gradient-stops 8A008A 00D1FF FFFFFF --easing IN_QUAD
    ```
---
...
[Reference](./effects/print.md){ .md-button } [Config](./effects/print.md#varoascii.effects.effect_print.PrintConfig){ .md-button }
...
??? example "Print Command Line Arguments"
    ...
    Example: varoascii print --final-gradient-stops 02b8bd c1f0e3 00ffa0 --final-gradient-steps 12 --print-head-return-speed 1.25 --print-speed 1 --print-head-easing IN_OUT_QUAD
    ```
---
...
[Reference](./effects/rain.md){ .md-button } [Config](./effects/rain.md#varoascii.effects.effect_rain.RainConfig){ .md-button }
...
??? example "Rain Command Line Arguments"
    ...
    Example: varoascii rain --rain-symbols o . , "*" "|" --rain-colors 00315C 004C8F 0075DB 3F91D9 78B9F2 9AC8F5 B8D8F8 E3EFFC --final-gradient-stops 488bff b2e7de 57eaf7 --final-gradient-steps 12 --movement-speed 0.1-0.2 --easing IN_QUART
    ```
---
...
[Reference](./effects/randomsequence.md){ .md-button } [Config](./effects/randomsequence.md#varoascii.effects.effect_random_sequence.RandomSequenceConfig){ .md-button }
...
??? example "RandomSequence Command Line Arguments"
    ...
    Example: varoascii randomsequence --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 --final-gradient-frames 12 --speed 0.004
    ```
---
...
[Reference](./effects/rings.md){ .md-button } [Config](./effects/rings.md#varoascii.effects.effect_rings.RingsConfig){ .md-button }
...
??? example "Rings Command Line Arguments"
    ...
    Example: varoascii rings --ring-colors ab48ff e7b2b2 fffebd --final-gradient-stops ab48ff e7b2b2 fffebd --final-gradient-steps 12 --ring-gap 0.1 --spin-duration 200 --spin-speed 0.25-1.0 --disperse-duration 200 --spin-disperse-cycles 3
    ```
---
...
[Reference](./effects/scattered.md){ .md-button } [Config](./effects/scattered.md#varoascii.effects.effect_scattered.ScatteredConfig){ .md-button }
...
??? example "Scattered Command Line Arguments"
    ...
    Example: varoascii scattered --final-gradient-stops ff9048 ab9dff bdffea --final-gradient-steps 12 --final-gradient-frames 12 --movement-speed 0.5 --movement-easing IN_OUT_BACK
    ```
---
...
[Reference](./effects/slice.md){ .md-button } [Config](./effects/slice.md#varoascii.effects.effect_slice.SliceConfig){ .md-button }
...
??? example "Slice Command Line Arguments"
    ...
    Example: varoascii slice --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12
...
[Reference](./effects/slide.md){ .md-button } [Config](./effects/slide.md#varoascii.effects.effect_slide.SlideConfig){ .md-button }
...
??? example "Slide Command Line Arguments"
    ...
    Example: varoascii slide --movement-speed 0.5 --grouping row --final-gradient-stops 833ab4 fd1d1d fcb045 --final-gradient-steps 12 --final-gradient-frames 10 --final-gradient-direction vertical --gap 3 --reverse-direction --merge --movement-easing OUT_QUAD
    ```
---
...
[Reference](./effects/smoke.md){ .md-button } [Config](./effects/smoke.md#varoascii.effects.effect_smoke.SmokeConfig){ .md-button }
...
??? example "Smoke Command Line Arguments"
    ...
    Example: varoascii smoke --starting-color 7A7A7A --smoke-symbols ░ ▒ ▓ ▒ ░ --smoke-gradient-stops 242424 FFFFFF --use-whole-canvas --final-gradient-stops 8A008A 00D1FF ffffff --final-gradient-steps 12 --final-gradient-direction vertical
    ```
---
...
[Reference](./effects/spotlights.md){ .md-button } [Config](./effects/spotlights.md#varoascii.effects.effect_spotlights.SpotlightsConfig){ .md-button }
...
??? example "Spotlights Command Line Arguments"
    ...
    Example: varoascii spotlights --final-gradient-stops ab48ff e7b2b2 fffebd --final-gradient-steps 12 --beam-width-ratio 2.0 --beam-falloff 0.3 --search-duration 750 --search-speed-range 0.25-0.5 --spotlight-count 3
    ```
---
...
[Reference](./effects/spray.md){ .md-button } [Config](./effects/spray.md#varoascii.effects.effect_spray.SprayConfig){ .md-button }
...
??? example "Spray Command Line Arguments"
    ...
    Example: varoascii spray --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 --spray-position e --spray-volume 0.005 --movement-speed 0.4-1.0 --movement-easing OUT_EXPO
    ```
---
...
[Reference](./effects/swarm.md){ .md-button } [Config](./effects/swarm.md#varoascii.effects.effect_swarm.SwarmConfig){ .md-button }
...
??? example "Swarm Command Line Arguments"
    ...
    Example: varoascii swarm --base-color 31a0d4 --flash-color f2ea79 --final-gradient-stops 31b900 f0ff65 --final-gradient-steps 12 --swarm-size 0.1 --swarm-coordination 0.80 --swarm-area-count 2-4
    ```
---
...
[Reference](./effects/sweep.md){ .md-button } [Config](./effects/sweep.md#varoascii.effects.effect_sweep.SweepConfig){ .md-button }
...
??? example "Sweep Command Line Arguments"
    ...
    Example: varoascii sweep --sweep-symbols '█' '▓' '▒' '░' --first-sweep-direction column_right_to_left --second-sweep-direction column_left_to_right --final-gradient-stops 8A008A 00D1FF ffffff --final-gradient-steps 8 8 8 --final-gradient-direction vertical
    ```
---
...
[Reference](./effects/synthgrid.md){ .md-button } [Config](./effects/synthgrid.md#varoascii.effects.effect_synthgrid.SynthGridConfig){ .md-button }
...
??? example "SynthGrid Command Line Arguments"
    ...
    Example: varoascii synthgrid --grid-gradient-stops CC00CC ffffff --grid-gradient-steps 12 --text-gradient-stops 8A008A 00D1FF FFFFFF --text-gradient-steps 12 --grid-row-symbol ─ --grid-column-symbol "│" --text-generation-symbols ░ ▒ ▓ --max-active-blocks 0.1
    ```
---
...
[Reference](./effects/thunderstorm.md){ .md-button } [Config](./effects/thunderstorm.md#varoascii.effects.effect_thunderstorm.ThunderstormConfig){ .md-button }
...
[Reference](./effects/unstable.md){ .md-button } [Config](./effects/unstable.md#varoascii.effects.effect_unstable.UnstableConfig){ .md-button }
...
??? example "Unstable Command Line Arguments"
    ...
    --reassembly-speed (float > 0)
        ...
        Example: varoascii unstable --unstable-color ff9200 --final-gradient-stops 8A008A 00D1FF FFFFFF --final-gradient-steps 12 --explosion-ease OUT_EXPO --explosion-speed 0.75 --reassembly-ease OUT_EXPO --reassembly-speed 0.75</details>
    ```
---
...
[Reference](./effects/vhstape.md){ .md-button } [Config](./effects/vhstape.md#varoascii.effects.effect_vhstape.VHSTapeConfig){ .md-button }
...
[Reference](./effects/waves.md){ .md-button } [Config](./effects/waves.md#varoascii.effects.effect_waves.WavesConfig){ .md-button }
...
??? example "Waves Command Line Arguments"
    ...
    Example: varoascii waves --wave-symbols ▁ ▂ ▃ ▄ ▅ ▆ ▇ █ ▇ ▆ ▅ ▄ ▃ ▂ ▁ --wave-gradient-stops f0ff65 ffb102 31a0d4 ffb102 f0ff65 --wave-gradient-steps 6 --final-gradient-stops ffb102 31a0d4 f0ff65 --final-gradient-steps 12 --wave-count 7 --wave-length 2 --wave-easing IN_OUT_SINE
    ```
---
...
[Reference](./effects/wipe.md){ .md-button } [Config](./effects/wipe.md#varoascii.effects.effect_wipe.WipeConfig){ .md-button }
...
??? example "Wipe Command Line Arguments"
    ...
    Example: varoascii wipe --wipe-direction diagonal_bottom_left_to_top_right --final-gradient-stops 833ab4 fd1d1d fcb045 --final-gradient-steps 12 --final-gradient-frames 5 --wipe-delay 0
    ```
